        ...
        <div className="container">
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                <p className="text__para">
                  ...
                  Ratione atque deserunt voluptas placeat nihil veniam assumenda
                  id quidem eveniet saepe facilis ullam delectus, doloremque, ut
                  iste ad repellat quasi fugit!
                </p>
            ...
            <div className="flex gap-[30px] justify-end">
              <div>
                <img className="w-full" src={heroImage01} alt="heroImages" />
              </div>
              <div>
                <div className="mt-[30px]">
                  <img
                    ...
                    alt="heroImages"
                  />
                  <img className="w-full" src={heroImage03} alt="heroImages" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="xl:w-[470px] mx-auto">
            ...
            <p className="text__para text-center">
              ...
              provident alias perferendis ut ex.
            </p>
          </div>
          <ServicesList />
        </div>
